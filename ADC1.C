...
void ADC1_vInit(void)
{
  ...
  ADC1_RSPR0     =  0x0002;      // load Priority and Arbitration register
  ...
  ADC1_CHCTR0    =  0x0404;      // load channel control register
  ...
  ADC1_CHCTR2    =  0x2404;      // load channel control register
  ...
  ADC1_CHCTR4    =  0x4404;      // load channel control register
